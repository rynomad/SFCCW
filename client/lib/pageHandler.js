...
(function() {
  var addToJournal, iced, pageFromLocalStorage, pageHandler, pushToLocal, pushToServer, recursiveGet, revision, state, util, __iced_k, __iced_k_noop;
  ...
  recursiveGet = function(_arg) {
    var closure, localContext, localPage, name, ndn, pageInformation, rev, site, slug, url, whenGotten, whenNotGotten, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    ...
    (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        ...
        filename: "pageHandler.iced",
        funcname: "recursiveGet"
      });
      name = new Name('/sfw' + url);
      ndn = new NDN({
        host: 'localhost'
